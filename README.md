<div align="center">
  ...
  <h1 align="center">Website Institucional para Startup da Área Hospitalar</h1>

  > Website responsivo para startup voltada para área hospitalar com React JS.

  <a href="https://github.com/p1nheiros/SupriTech"><strong>➥ Visualizar Projeto</strong></a>
...
```bash
sudo git clone https://github.com/p1nheiros/SupriTech.git
```

Windows:

```bash
git clone https://github.com/p1nheiros/SupriTech.git
```
